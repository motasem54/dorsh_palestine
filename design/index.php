                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="collection-item">
                        ...
                        <div class="collection-content">
                            ...
                            <a href="#" class="collection-link">View Collection <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="collection-item">
                        ...
                        <div class="collection-content">
                            ...
                            <a href="#" class="collection-link">Shop Now <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="swiper productsSwiper" data-aos="fade-up" data-aos-delay="200">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                ...
                                <img src="https://images.unsplash.com/photo-1584990347449-39e6082f2b6c?w=400&h=400&fit=crop" alt="Premium Casserole">
                            ...
                            <div class="product-info">
                                <span class="category">Premium Cookware</span>
                                <h4><a href="#">Premium Casserole 28cm</a></h4>
                                <p class="product-code">DH-05468</p>
                                <div class="product-price">
                                    $89.00 <del>$110.00</del>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Product 2: Frying Pan -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <span class="product-badge new">New</span>
                                <img src="https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=400&h=400&fit=crop" alt="Frying Pan">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                <span class="category">Premium Cookware</span>
                                <h4><a href="#">Premium Fry Pan 28cm</a></h4>
                                <p class="product-code">DH-05488</p>
                                <div class="product-price">
                                    $75.00
                                </div>
                            </div>
                    ...
                    <!-- Product 3: GoPress Pressure Cooker -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <img src="https://images.unsplash.com/photo-1585515320310-259814833e62?w=400&h=400&fit=crop" alt="Pressure Cooker">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                <span class="category">GoPress</span>
                                <h4><a href="#">GoPress Pressure Cooker 6L</a></h4>
                                <p class="product-code">DH-06436</p>
                                <div class="product-price">
                                    $129.00
                                </div>
                            </div>
                    ...
                    <!-- Product 4: Whistling Kettle -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <span class="product-badge">Sale</span>
                                <img src="https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=400&h=400&fit=crop" alt="Kettle">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                ...
                                <h4><a href="#">Whistling Tea Kettle 2.5L</a></h4>
                                <p class="product-code">DH-02906</p>
                                <div class="product-price">
                                    $45.00 <del>$60.00</del>
                                </div>
                            </div>
                    ...
                    <!-- Product 5: Safari Cutlery Set -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <img src="https://images.unsplash.com/photo-1578926314433-e2789279f4aa?w=400&h=400&fit=crop" alt="Cutlery Set">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                ...
                                <h4><a href="#">Safari Cutlery Set 72 Pcs</a></h4>
                                <p class="product-code">DH-01998</p>
                                <div class="product-price">
                                    $199.00
                                </div>
                            </div>
                    ...
                    <!-- Product 6: Classic Knife Set -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <img src="https://images.unsplash.com/photo-1593618998160-e34014e67546?w=400&h=400&fit=crop" alt="Knife Set">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                <span class="category">Cut & Carv</span>
                                <h4><a href="#">Classic Knife Set 14 Pcs</a></h4>
                                <p class="product-code">DH-04659</p>
                                <div class="product-price">
                                    $149.00
                                </div>
                            </div>
                    ...
                    <!-- Product 7: Muffin Pan -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <span class="product-badge new">New</span>
                                <img src="https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?w=400&h=400&fit=crop" alt="Muffin Pan">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                <span class="category">Bakeware</span>
                                <h4><a href="#">Muffin Pan 12 Cups</a></h4>
                                <p class="product-code">DH-08908</p>
                                <div class="product-price">
                                    $35.00
                                </div>
                            </div>
                    ...
                    <!-- Product 8: SteelPro Stock Pot -->
                    <div class="swiper-slide">
                        <div class="product-card">
                            <div class="product-thumb">
                                <img src="https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&h=400&fit=crop" alt="Stock Pot">
                                <div class="product-actions">
                                    <button title="Add to Wishlist"><i class="far fa-heart"></i></button>
                                    <button title="Quick View"><i class="far fa-eye"></i></button>
                                    <button title="Add to Cart"><i class="fas fa-shopping-cart"></i></button>
                            ...
                            <div class="product-info">
                                <span class="category">SteelPro</span>
                                <h4><a href="#">Stainless Steel Stock Pot 32cm</a></h4>
                                <p class="product-code">DH-03832</p>
                                <div class="product-price">
                                    $95.00
                                </div>
                            </div>
